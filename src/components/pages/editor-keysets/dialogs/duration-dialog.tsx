    ...
    >
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Set key and relevant description
          </DialogDescription>
        </DialogHeader>
        <div className="flex flex-col gap-1.5">
          <p>Behavioral Target (e.g., SR):</p>
          <Input
            className="mb-2"
          ...
          <p>Key Capture (Note: Press key to assign):</p>
          <Input
            className="mb-2"
            ...
            onKeyDownCapture={(event) => {
              if (event.shiftKey || event.ctrlKey) {
                ...
                displayConditionalNotification(
                  ...
                  `You cannot use the '${event.key}' key (i.e., no capitalization).`,
                  3000,
                  true
                );
                return;
