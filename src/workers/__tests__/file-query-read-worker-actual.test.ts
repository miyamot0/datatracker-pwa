...
describe('FileQueryReadWorker Actual Integration', () => {
  ...
  describe('Query Operations', () => {
    ...
    it('should process FETCH_CONDITIONS message', async () => {
      ...
      // Verify the query function was called
      expect(fetchConditions).toHaveBeenCalledWith(
        testHandle,
        'test-group',
        'test-individual',
        'test-evaluation'
    ...
    it('should process FETCH_KEYSETS message', async () => {
      ...
      // Verify the query function was called
      expect(fetchKeysets).toHaveBeenCalledWith(
        testHandle,
        'test-group',
        'test-individual'
      );
    ...
    it('should process FETCH_KEYSETS_ALL message', async () => {
      ...
      // Verify the query function was called
      expect(fetchKeysetsAll).toHaveBeenCalledWith(
        testHandle,
        'test-group',
        'test-individual'
      );
    ...
    it('should process FETCH_SESSION_PARAMS message', async () => {
      ...
      // Verify the query function was called
      expect(fetchSessionParams).toHaveBeenCalledWith(
        testHandle,
        'test-group', 
        'test-individual',
        'test-evaluation'
    ...
    it('should process FETCH_OUTCOMES message', async () => {
      ...
      // Verify the query function was called
      expect(fetchSessionOutcomes).toHaveBeenCalledWith(
        testHandle,
        'test-group',
        'test-individual',
        'test-evaluation'
  ...
  describe('Real FileSystem API Integration Patterns', () => {
    ...
    it('should handle query result type variations', async () => {
      ...
      const responses = receivedMessages.filter(r => 
        ['empty-array', 'single-item', 'complex-object'].includes(r.id)
      );
