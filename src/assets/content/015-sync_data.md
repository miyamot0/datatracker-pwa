...
![Image of DataTracker sync option](docs/sync_unauthorized.png 'Image of DataTracker sync option')
...
![Image of DataTracker sync option](docs/sync_authorized.png 'Image of DataTracker sync option')
...
![Image of DataTracker sync screen with button auth](docs/sync_screen_folder_auth.png 'Visual of sync screen with button auth')
...
![Image of DataTracker sync screen with button auth](docs/sync_screen_folders_list_from.png 'Visual of sync screen FROM remote')
