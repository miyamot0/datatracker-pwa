...
import { DEFAULT_KEY_SET } from "../keyset";
...
describe("toSavedSettings", () => {
  ...
  it("should handle empty or default values in the session designer schema", () => {
    const input: SessionDesignerSchemaType = {
      SessionTherapistID: "",
      DataCollectorID: "",
      DataCollectorRole: "Secondary" as DataCollectorRolesType,
      SessionDurationS: 0,
      SessionTerminationOption:
        "End on Secondary Timer" as SessionTerminationOptionsType,
      SessionNumber: 1,
      SessionKeySet: DEFAULT_KEY_SET,
      SessionCondition: "",
    };
    ...
    const expectedOutput: SavedSettings = {
      ...
      Role: "Secondary",
      DurationS: 0,
      TimerOption: "End on Secondary Timer",
      Session: 1,
      KeySet: DEFAULT_KEY_SET,
      Condition: "",
    };
